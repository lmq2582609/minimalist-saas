...
import com.minimalist.common.fileHandler.entity.LocalFileEntity;
...
public class LocalFileHandler implements FileHandler {
    ...
    public MFile uploadFile(MultipartFile multipartFile, Integer fileSource, MStorage storage) {
        //根据文件来源，获取相对路径
        String fileSourcePath = FileEnum.FileSource.getPath(fileSource);
        //本地存储路径
        ...
        String url = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/files/";
        //返回的文件信息
