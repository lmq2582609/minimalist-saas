...
-- Records of m_config
-- ----------------------------
INSERT INTO `m_config` VALUES (1, 1833741434936000512, '系统参数-多租户开关', 'system.config.tenant', 'true', 'true开启多租户，false关闭多租户', 1, 0, '2024-09-11 13:36:42.050638', 0, '2025-07-20 10:08:27.000000', b'0', 11);
...
INSERT INTO `m_config` VALUES (8, 1833773744087523329, '部门管理菜单参数', 'dept_enable_params', '{\"perm_name\":\"部门管理\",\"perm_path\":\"/basic/dept/mgt\"}', '部门管理功能开关对应的菜单匹配条件', 1, 0, '2026-08-05 20:15:24.000000', 0, '2026-08-05 20:15:29.000000', b'0', 0);
INSERT INTO `m_config` VALUES (9, 1833773744087523330, '岗位管理菜单参数', 'post_enable_params', '{\"perm_name\":\"岗位管理\",\"perm_path\":\"/basic/post/mgt\"}', '岗位管理功能开关对应的菜单匹配条件', 1, 0, '2026-08-05 20:15:27.000000', 0, '2026-08-05 20:15:32.000000', b'0', 0);
...
CREATE TABLE `m_dict`  (
                           ...
                           `version` int(0) NULL DEFAULT 0 COMMENT '版本号',
                           PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 144 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典表' ROW_FORMAT = Dynamic;
...
INSERT INTO `m_dict` VALUES (137, 1899098996038688768, 'file-type', 'image', '图片', '文件类型', '文件类型，与file表中file_type字段对应', 0, 'orange', 1, 0, '2025-03-10 22:04:18.000000', 0, '2025-04-13 17:10:23.000000', b'0', 4);
INSERT INTO `m_dict` VALUES (138, 1899098996160323584, 'file-type', 'video', '视频', '文件类型', '文件类型，与file表中file_type字段对应', 1, 'blue', 1, 0, '2025-03-10 22:04:18.000000', 0, '2025-04-13 17:10:23.000000', b'0', 4);
...
) ENGINE = InnoDB AUTO_INCREMENT = 294 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for m_func_config
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '功能配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of m_func_config
-- ----------------------------
INSERT INTO `m_func_config` VALUES (1, 1, '部门管理开关', 'feature.dept.enable', 'true', '是否启用部门管理功能', 0, '2026-08-04 22:31:25.000000', 0, '2026-08-06 21:14:39.000000', b'0', 12);
INSERT INTO `m_func_config` VALUES (2, 2, '岗位管理开关', 'feature.post.enable', 'true', '是否启用岗位管理功能', 0, '2026-08-04 22:31:31.000000', 0, '2026-08-05 20:26:16.000000', b'0', 4);
...
INSERT INTO `m_perms` VALUES (16, 1673524365792530432, NULL, '部门管理', 1669336412647133184, 40, '/basic/dept/mgt', 'IconMindMapping', 'M', '/basic/dept/DeptMgt.vue', b'0', b'1', '', 1, 0, '2023-06-27 10:51:16.041741', 0, '2026-08-05 20:26:15.000000', b'0', 11);
INSERT INTO `m_perms` VALUES (17, 1673524591861321728, NULL, '岗位管理', 1669336412647133184, 45, '/basic/post/mgt', 'IconBulb', 'M', '/basic/post/PostMgt.vue', b'0', b'1', '', 1, 0, '2023-06-27 10:52:09.940810', 0, '2026-08-05 20:26:16.000000', b'0', 9);
...
INSERT INTO `m_perms` VALUES (43, 1685996318275985408, 'basic:dept:add', '添加部门', 1673524365792530432, 10, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:50:21.231736', 0, '2026-08-05 20:26:15.000000', b'0', 6);
INSERT INTO `m_perms` VALUES (44, 1685996426530971648, 'basic:dept:delete', '删除部门', 1673524365792530432, 20, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:50:47.041079', 0, '2026-08-05 20:26:15.000000', b'0', 6);
INSERT INTO `m_perms` VALUES (45, 1685996547448561664, 'basic:dept:update', '修改部门', 1673524365792530432, 30, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:51:15.869518', 0, '2026-08-05 20:26:15.000000', b'0', 6);
INSERT INTO `m_perms` VALUES (46, 1685996623386435584, 'basic:dept:get', '查询部门', 1673524365792530432, 40, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:51:33.974273', 0, '2026-08-05 20:26:15.000000', b'0', 6);
INSERT INTO `m_perms` VALUES (47, 1685996875623489536, 'basic:post:add', '添加岗位', 1673524591861321728, 10, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:52:34.113986', 0, '2026-08-05 20:26:16.000000', b'0', 4);
INSERT INTO `m_perms` VALUES (48, 1685997536914235392, 'basic:post:delete', '删除岗位', 1673524591861321728, 20, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:55:11.777212', 0, '2026-08-05 20:26:16.000000', b'0', 4);
INSERT INTO `m_perms` VALUES (49, 1685997640341577728, 'basic:post:update', '修改岗位', 1673524591861321728, 30, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:55:36.435155', 0, '2026-08-05 20:26:16.000000', b'0', 4);
INSERT INTO `m_perms` VALUES (50, 1685997732956004352, 'basic:post:get', '查询岗位', 1673524591861321728, 40, NULL, NULL, 'B', NULL, b'0', b'1', '', 1, 0, '2023-07-31 20:55:58.516359', 0, '2026-08-05 20:26:16.000000', b'0', 4);
...
INSERT INTO `m_perms` VALUES (92, 2084788642533359616, NULL, '功能配置', 1669336412647133184, 65, '/basic/funcConfig/mgt', 'IconEdit', 'M', '/basic/funcConfig/FuncConfigMgt', b'0', b'1', NULL, 1, 0, '2026-08-05 07:48:40.000000', 0, '2026-08-05 07:48:49.000000', b'0', 2);
INSERT INTO `m_perms` VALUES (93, 2084788774230310912, 'basic:funcConfig:get', '功能配置查询', 2084788642533359616, 10, NULL, NULL, 'B', NULL, b'0', b'1', NULL, 1, 0, '2026-08-05 07:49:11.000000', 0, '2026-08-05 07:49:11.000000', b'0', 0);
INSERT INTO `m_perms` VALUES (94, 2084788868061085696, 'basic:funcConfig:update', '功能配置修改', 2084788642533359616, 20, NULL, NULL, 'B', NULL, b'0', b'1', NULL, 1, 0, '2026-08-05 07:49:34.000000', 0, '2026-08-05 07:49:34.000000', b'0', 0);
...
CREATE TABLE `m_role`  (
                           ...
                           `version` int(0) NULL DEFAULT 0 COMMENT '版本号',
                           PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 121 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of m_role
-- ----------------------------
INSERT INTO `m_role` VALUES (101, 1671337763855073280, '系统管理员', 'system_admin', 0, 1, NULL, 0, 0, '2023-06-21 10:02:29.514290', 0, '2026-08-05 20:25:01.000000', b'0', 51);
...
CREATE TABLE `m_role_perm`  (
                                ...
                                INDEX `role_id_idx`(`role_id`) USING BTREE COMMENT '角色ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 2429 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色与权限关联表 1角色-N权限' ROW_FORMAT = Dynamic;
...
INSERT INTO `m_role_perm` VALUES (2361, 1671337763855073280, 1673863803093557248);
INSERT INTO `m_role_perm` VALUES (2362, 1671337763855073280, 1685985572129398784);
INSERT INTO `m_role_perm` VALUES (2363, 1671337763855073280, 1685985875515990016);
INSERT INTO `m_role_perm` VALUES (2364, 1671337763855073280, 1685985977349496832);
INSERT INTO `m_role_perm` VALUES (2365, 1671337763855073280, 1685986276453703680);
INSERT INTO `m_role_perm` VALUES (2366, 1671337763855073280, 1669338708936298496);
INSERT INTO `m_role_perm` VALUES (2367, 1671337763855073280, 1685986566443687936);
INSERT INTO `m_role_perm` VALUES (2368, 1671337763855073280, 1685986702834065408);
INSERT INTO `m_role_perm` VALUES (2369, 1671337763855073280, 1685986806387236864);
INSERT INTO `m_role_perm` VALUES (2370, 1671337763855073280, 1685986887102423040);
INSERT INTO `m_role_perm` VALUES (2371, 1671337763855073280, 1673167646340120576);
INSERT INTO `m_role_perm` VALUES (2372, 1671337763855073280, 1685987612687654912);
INSERT INTO `m_role_perm` VALUES (2373, 1671337763855073280, 1685987708229705728);
INSERT INTO `m_role_perm` VALUES (2374, 1671337763855073280, 1685988419789185024);
INSERT INTO `m_role_perm` VALUES (2375, 1671337763855073280, 1685988623951126528);
INSERT INTO `m_role_perm` VALUES (2376, 1671337763855073280, 1669339147886989312);
INSERT INTO `m_role_perm` VALUES (2377, 1671337763855073280, 1685996318275985408);
INSERT INTO `m_role_perm` VALUES (2378, 1671337763855073280, 1685996426530971648);
INSERT INTO `m_role_perm` VALUES (2379, 1671337763855073280, 1685996547448561664);
INSERT INTO `m_role_perm` VALUES (2380, 1671337763855073280, 1685996623386435584);
INSERT INTO `m_role_perm` VALUES (2381, 1671337763855073280, 1673524365792530432);
INSERT INTO `m_role_perm` VALUES (2382, 1671337763855073280, 1685996875623489536);
INSERT INTO `m_role_perm` VALUES (2383, 1671337763855073280, 1685997536914235392);
INSERT INTO `m_role_perm` VALUES (2384, 1671337763855073280, 1685997640341577728);
INSERT INTO `m_role_perm` VALUES (2385, 1671337763855073280, 1685997732956004352);
INSERT INTO `m_role_perm` VALUES (2386, 1671337763855073280, 1673524591861321728);
INSERT INTO `m_role_perm` VALUES (2387, 1671337763855073280, 1685998041879076864);
INSERT INTO `m_role_perm` VALUES (2388, 1671337763855073280, 1685998171407572992);
INSERT INTO `m_role_perm` VALUES (2389, 1671337763855073280, 1685998244715618304);
INSERT INTO `m_role_perm` VALUES (2390, 1671337763855073280, 1685998340425441280);
INSERT INTO `m_role_perm` VALUES (2391, 1671337763855073280, 1669339375922909184);
INSERT INTO `m_role_perm` VALUES (2392, 1671337763855073280, 1846813160695615488);
INSERT INTO `m_role_perm` VALUES (2393, 1671337763855073280, 1846813266043949056);
INSERT INTO `m_role_perm` VALUES (2394, 1671337763855073280, 1846813437867806720);
INSERT INTO `m_role_perm` VALUES (2395, 1671337763855073280, 1846813517064654848);
INSERT INTO `m_role_perm` VALUES (2396, 1671337763855073280, 1683285343149096960);
INSERT INTO `m_role_perm` VALUES (2397, 1671337763855073280, 1843900739123359744);
INSERT INTO `m_role_perm` VALUES (2398, 1671337763855073280, 1843900820899704832);
INSERT INTO `m_role_perm` VALUES (2399, 1671337763855073280, 1843900873001349120);
INSERT INTO `m_role_perm` VALUES (2400, 1671337763855073280, 1843900946787545088);
INSERT INTO `m_role_perm` VALUES (2401, 1671337763855073280, 1843898617245937664);
INSERT INTO `m_role_perm` VALUES (2402, 1671337763855073280, 1686002657173757952);
INSERT INTO `m_role_perm` VALUES (2403, 1671337763855073280, 1686002750660599808);
INSERT INTO `m_role_perm` VALUES (2404, 1671337763855073280, 1686002863185387520);
INSERT INTO `m_role_perm` VALUES (2405, 1671337763855073280, 1686002975089418240);
INSERT INTO `m_role_perm` VALUES (2406, 1671337763855073280, 1676499559247155200);
INSERT INTO `m_role_perm` VALUES (2407, 1671337763855073280, 1686004858881368064);
INSERT INTO `m_role_perm` VALUES (2408, 1671337763855073280, 1686005292303966208);
INSERT INTO `m_role_perm` VALUES (2409, 1671337763855073280, 1686005483111243776);
INSERT INTO `m_role_perm` VALUES (2410, 1671337763855073280, 1686005567790047232);
INSERT INTO `m_role_perm` VALUES (2411, 1671337763855073280, 1676501907755405312);
INSERT INTO `m_role_perm` VALUES (2412, 1671337763855073280, 1676499330464649216);
INSERT INTO `m_role_perm` VALUES (2413, 1671337763855073280, 1686001693859569664);
INSERT INTO `m_role_perm` VALUES (2414, 1671337763855073280, 1686001770980237312);
INSERT INTO `m_role_perm` VALUES (2415, 1671337763855073280, 1686002193703165952);
INSERT INTO `m_role_perm` VALUES (2416, 1671337763855073280, 1686002291338174464);
INSERT INTO `m_role_perm` VALUES (2417, 1671337763855073280, 1681273378598850560);
INSERT INTO `m_role_perm` VALUES (2418, 1671337763855073280, 1833688664656728064);
INSERT INTO `m_role_perm` VALUES (2419, 1671337763855073280, 1833688838682595328);
INSERT INTO `m_role_perm` VALUES (2420, 1671337763855073280, 1833688910472302592);
INSERT INTO `m_role_perm` VALUES (2421, 1671337763855073280, 1833688972682219520);
INSERT INTO `m_role_perm` VALUES (2422, 1671337763855073280, 1833687152849211392);
INSERT INTO `m_role_perm` VALUES (2423, 1671337763855073280, 1846819585257852928);
INSERT INTO `m_role_perm` VALUES (2424, 1671337763855073280, 1680749851857862656);
INSERT INTO `m_role_perm` VALUES (2425, 1671337763855073280, 2084788642533359616);
INSERT INTO `m_role_perm` VALUES (2426, 1671337763855073280, 1669336412647133184);
INSERT INTO `m_role_perm` VALUES (2427, 1671337763855073280, 2084788774230310912);
INSERT INTO `m_role_perm` VALUES (2428, 1671337763855073280, 2084788868061085696);
...
CREATE TABLE `m_tenant`  (
                             ...
                             `version` int(0) NULL DEFAULT 0 COMMENT '版本号',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of m_tenant
-- ----------------------------
INSERT INTO `m_tenant` VALUES (1, 0, 0, 0, '系统租户', '2030-12-31 23:59:59.000000', 20, 'master', NULL, NULL, 1, 0, '2025-02-14 21:54:35.000000', 0, '2025-02-14 21:54:58.000000', b'0', 0);
...
CREATE TABLE `m_tenant_datasource`  (
                                        ...
                                        `host` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '数据库主机地址',
                                        `port` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '3306' COMMENT '数据库端口',
                                        ...
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户数据源表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `m_tenant_package` VALUES (5, 1676850220841287680, '基础套餐', 1, '基础套餐', 0, '2023-07-06 15:07:01.676599', 0, '2026-08-05 20:57:04.000000', b'0', 27);
...
CREATE TABLE `m_tenant_package_perm`  (
                                          ...
                                          `perm_id` bigint(0) NOT NULL COMMENT '权限ID',
                                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 727 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户套餐与权限关联表' ROW_FORMAT = Dynamic;
...
INSERT INTO `m_tenant_package_perm` VALUES (703, 1676850220841287680, 1669336412647133184);
INSERT INTO `m_tenant_package_perm` VALUES (704, 1676850220841287680, 1685986566443687936);
INSERT INTO `m_tenant_package_perm` VALUES (705, 1676850220841287680, 1685986702834065408);
INSERT INTO `m_tenant_package_perm` VALUES (706, 1676850220841287680, 1685986806387236864);
INSERT INTO `m_tenant_package_perm` VALUES (707, 1676850220841287680, 1685986887102423040);
INSERT INTO `m_tenant_package_perm` VALUES (708, 1676850220841287680, 1673167646340120576);
INSERT INTO `m_tenant_package_perm` VALUES (709, 1676850220841287680, 1685985572129398784);
INSERT INTO `m_tenant_package_perm` VALUES (710, 1676850220841287680, 1685985875515990016);
INSERT INTO `m_tenant_package_perm` VALUES (711, 1676850220841287680, 1685985977349496832);
INSERT INTO `m_tenant_package_perm` VALUES (712, 1676850220841287680, 1685986276453703680);
INSERT INTO `m_tenant_package_perm` VALUES (713, 1676850220841287680, 1669338708936298496);
INSERT INTO `m_tenant_package_perm` VALUES (714, 1676850220841287680, 1685996318275985408);
INSERT INTO `m_tenant_package_perm` VALUES (715, 1676850220841287680, 1685996426530971648);
INSERT INTO `m_tenant_package_perm` VALUES (716, 1676850220841287680, 1685996547448561664);
INSERT INTO `m_tenant_package_perm` VALUES (717, 1676850220841287680, 1685996623386435584);
INSERT INTO `m_tenant_package_perm` VALUES (718, 1676850220841287680, 1673524365792530432);
INSERT INTO `m_tenant_package_perm` VALUES (719, 1676850220841287680, 1685996875623489536);
INSERT INTO `m_tenant_package_perm` VALUES (720, 1676850220841287680, 1685997536914235392);
INSERT INTO `m_tenant_package_perm` VALUES (721, 1676850220841287680, 1685997640341577728);
INSERT INTO `m_tenant_package_perm` VALUES (722, 1676850220841287680, 1685997732956004352);
INSERT INTO `m_tenant_package_perm` VALUES (723, 1676850220841287680, 1673524591861321728);
INSERT INTO `m_tenant_package_perm` VALUES (724, 1676850220841287680, 2084788774230310912);
INSERT INTO `m_tenant_package_perm` VALUES (725, 1676850220841287680, 2084788868061085696);
INSERT INTO `m_tenant_package_perm` VALUES (726, 1676850220841287680, 2084788642533359616);
...
) ENGINE = InnoDB AUTO_INCREMENT = 73 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户与岗位关联表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for m_user_index
-- ----------------------------
DROP TABLE IF EXISTS `m_user_index`;
CREATE TABLE `m_user_index`  (
                                 `id` bigint(0) NOT NULL AUTO_INCREMENT,
                                 `username` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户账号',
                                 `tenant_id` bigint(0) NOT NULL COMMENT '所属租户ID',
                                 `status` tinyint(0) NULL DEFAULT 1 COMMENT '状态 0禁用 1正常',
                                 PRIMARY KEY (`id`) USING BTREE,
                                 UNIQUE INDEX `unq_username`(`username`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '全局用户账号索引' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of m_user_index
-- ----------------------------
INSERT INTO `m_user_index` VALUES (1, 'admin', 0, 1);
...
CREATE TABLE `m_user_post`  (
                                ...
                                INDEX `user_id_idx`(`user_id`) USING BTREE COMMENT '用户ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户与岗位关联表 1用户-N岗位' ROW_FORMAT = Dynamic;
...
CREATE TABLE `m_user_role`  (
                                ...
                                INDEX `role_id_idx`(`role_id`) USING BTREE COMMENT '角色ID索引',
                                INDEX `user_id_idx`(`user_id`) USING BTREE COMMENT '用户ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户与角色关联表 1用户-N角色' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of m_user_role
-- ----------------------------
INSERT INTO `m_user_role` VALUES (27, 0, 1671337763855073280);
INSERT INTO `m_user_role` VALUES (32, 2082833782602825729, 2082833785094242304);
INSERT INTO `m_user_role` VALUES (33, 2082838601971306497, 2082838604454334464);
INSERT INTO `m_user_role` VALUES (34, 2082839132844371969, 2082839135444840448);
