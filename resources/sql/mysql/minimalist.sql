...
CREATE TABLE `m_tenant_package_perm`  (
  ...
  `perm_id` bigint(0) NOT NULL COMMENT '权限ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 253 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户套餐与权限关联表' ROW_FORMAT = Dynamic;
...
INSERT INTO `m_user` VALUES (2, 1679006018092986368, '1677964435873116160,1686021621496999936', 'dongdong', '$2a$10$2P1a5eMGKOhgFgLUsdfixOtfWu22XqgxQWsvLnZNCWDMGOUZnYLwm', '东少', '东东', '15000000000@phone.com', '15000000000', 1, NULL, '东东无敌', 1, 1677573374205501440, 1655941826117689345, '2023-07-12 13:53:23.795803', 1655941826117689345, '2023-08-06 16:18:05.167424', b'1', 1);
